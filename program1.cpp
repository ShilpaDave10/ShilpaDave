...
int main()
{
s1.resource_all_resources=0;s1.resource_paper=0;s1.resource_pen
=0;s1.resource_question_paper=0;
s2.resource_all_resources=0;s2.resource_paper=0;s2.resource_pen
=0;s2.resource_question_paper=0;
s3.resource_all_resources=0;s3.resource_paper=0;s3.resource_pen
=0;s3.resource_question_paper=0;
do
{
int a,b;
...
cout<<"Select any two items to be placed on the sharedtable:"<<endl;
cin>>a>>b;
...
while(s1.resource_all_resources==0||s2.resource_all_resources==
0||s3.resource_all_resources==0);
